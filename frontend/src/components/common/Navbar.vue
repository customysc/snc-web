<template>
  ...
  >
    ...
    <el-menu-item index="/bbs/1">临时-论坛详情页跳转</el-menu-item>
    <el-menu-item index="/okr">OKR系统</el-menu-item>
    <el-menu-item index="/login">临时-登录模拟跳转</el-menu-item>
    <el-sub-menu index="2-4">
      ...
      <el-menu-item index="/fin">财务支出管理</el-menu-item>
    </el-sub-menu>
  </el-menu>
</template>
