<template>
  <LoginLayout>
    <template #form>
      ...
      <!-- 登录表单 -->
      <el-form :model="formData" :rules="loginRules" ref="loginFormRef" label-position="top" hide-required-asterisk>
        <!-- 邮箱输入框 -->
        <el-form-item label="邮箱" prop="email">
          <el-input v-model="formData.email"  placeholder="请输入邮箱"/> </el-form-item>
        <!-- 密码输入框 -->
...
import {login } from "@/views/login/login.api.ts";
